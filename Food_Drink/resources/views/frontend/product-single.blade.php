	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mb-5 ftco-animate">
				<a href="images/menu-2.jpg" class="image-popup"><img src="frontend/assets/images/menu-2.jpg"
						class="img-fluid" alt="Colorlib Template"></a>
			</div>
			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
				<h3>Creamy Latte KHMER FOOD</h3>
				...
				<p><a href="http://127.0.0.1:8000/cart" class="btn btn-primary py-3 px-5">Add to Cart</a></p>
			</div>
		</div>
	</div>
</section>
